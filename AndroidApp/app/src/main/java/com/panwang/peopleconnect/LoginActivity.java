    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                ...
                keys.add("cell"); values.add("+8615821112604");
                keys.add("device"); values.add("xxxiiiffff");
                HttpRequests.InitSSL(getAssets().open("server.crt"));
                String result = HttpRequests.HttpsPost("https://192.168.0.103:8080/register", keys, values);
